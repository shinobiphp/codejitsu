...
final class VesselSession
{
    ...
    public function __construct(private readonly AiRuntime $runtime, private readonly string $instructions, private readonly ?string $model, private readonly array $tools, private readonly array $limits, private readonly array $metadata) {}
    public function send(string $prompt): AiResponse
    {
        ...
        $response = $this->runtime->run(new AiRequest($this->instructions, $this->messages, $this->model, $this->tools, $this->limits, $this->metadata));
