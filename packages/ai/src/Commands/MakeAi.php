...
final class MakeAi
{
    ...
    public static function vessel(ExecutionContext $c): string { return self::made('Vessel', self::scaffolder($c)->vessel(self::value($c,0,'Vessel name: '), self::value($c,1,'Runtime: ','neuron'), self::value($c,2,'Spark: '))); }
