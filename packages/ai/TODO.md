...
- [ ] Support persisted and resumable Vessel sessions.
- [ ] Add Provider adapters as real use cases require them.
- [ ] Add MCP integration in the appropriate integration package.
- [ ] Add Context search and richer multi-selection to `ai:tui`.
